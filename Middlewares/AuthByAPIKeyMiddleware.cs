...
{
    /// <summary>
    /// Extension method used to add the `AuthByKeyMiddleware` to the HTTP request pipeline.
    /// </summary>
    /// <param name="builder">The `IApplicationBuilder` instance to configure the middleware.</param>
